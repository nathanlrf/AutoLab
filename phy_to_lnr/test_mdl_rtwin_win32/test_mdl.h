...
#define test_mdl_rtModel               RT_MODEL_test_mdl_T
...
#define rtB                            test_mdl_B
#define BlockIO                        B_test_mdl_T
#define rtP                            test_mdl_P
#define Parameters                     P_test_mdl_T
#define rtDWork                        test_mdl_DW
#define D_Work                         DW_test_mdl_T
...
/* Block signals (auto storage) */
extern B_test_mdl_T test_mdl_B;
...
extern void test_mdl_output(void);
extern void test_mdl_update(void);
