###########################################################################
## Makefile generated for Simulink model 'auto2exp'. 
## 
## Makefile     : auto2exp.mk
## Generated on : Mon Mar 17 12:03:12 2014
## MATLAB Coder version: 2.5 (R2013b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\auto2exp.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\Users\nathanlrf\Documents\MATLAB\senior_graduation_work\experiment_digital
ARCH                      = win32
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = C89/C90 (ANSI)
MODELREF_LINK_RSPFILE_NAME = auto2exp_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = auto2exp_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\auto2exp.exe
...
INCLUDES_BUILDINFO = $(START_DIR)\auto2exp_grt_rtw;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common
...
DEFINES_STANDARD = -DMODEL=auto2exp -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\auto2exp_grt_rtw\auto2exp.c $(START_DIR)\auto2exp_grt_rtw\auto2exp_data.c $(START_DIR)\auto2exp_grt_rtw\rtGetInf.c $(START_DIR)\auto2exp_grt_rtw\rtGetNaN.c $(START_DIR)\auto2exp_grt_rtw\rt_nonfinite.c rt_logging.c
...
OBJS = auto2exp.obj auto2exp_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_logging.obj
...
{$(START_DIR)\auto2exp_grt_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\auto2exp_grt_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
