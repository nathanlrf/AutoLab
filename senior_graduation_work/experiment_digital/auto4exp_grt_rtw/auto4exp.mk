###########################################################################
## Makefile generated for Simulink model 'auto4exp'. 
## 
## Makefile     : auto4exp.mk
## Generated on : Mon Mar 17 16:16:37 2014
## MATLAB Coder version: 2.5 (R2013b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\auto4exp.exe
...
MODELREF_LINK_RSPFILE_NAME = auto4exp_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = auto4exp_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\auto4exp.exe
...
INCLUDES_BUILDINFO = $(START_DIR)\auto4exp_grt_rtw;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common
...
DEFINES_STANDARD = -DMODEL=auto4exp -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\auto4exp_grt_rtw\auto4exp.c $(START_DIR)\auto4exp_grt_rtw\auto4exp_data.c $(START_DIR)\auto4exp_grt_rtw\rtGetInf.c $(START_DIR)\auto4exp_grt_rtw\rtGetNaN.c $(START_DIR)\auto4exp_grt_rtw\rt_nonfinite.c rt_logging.c
...
OBJS = auto4exp.obj auto4exp_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_logging.obj
...
{$(START_DIR)\auto4exp_grt_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\auto4exp_grt_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
