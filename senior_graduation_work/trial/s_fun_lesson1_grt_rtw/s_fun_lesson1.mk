###########################################################################
## Makefile generated for Simulink model 's_fun_lesson1'. 
## 
## Makefile     : s_fun_lesson1.mk
## Generated on : Tue Mar 11 16:00:12 2014
## MATLAB Coder version: 2.5 (R2013b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/s_fun_lesson1.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/nathanlrf/Documents/MATLAB/senior_graduation_work/trial
ARCH                      = win32
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = C89/C90 (ANSI)
MODELREF_LINK_RSPFILE_NAME = s_fun_lesson1_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = s_fun_lesson1_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/s_fun_lesson1.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR)/s_fun_lesson1_grt_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_BUILD_ARGS = -DMAT_FILE=1 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DONESTEPFCN=1 -DTERMFCN=1 -DMULTI_INSTANCE_CODE=0
DEFINES_IMPLIED = -DTID01EQ=1
DEFINES_STANDARD = -DMODEL=s_fun_lesson1 -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/s_fun_lesson1_grt_rtw/rtGetInf.c $(START_DIR)/s_fun_lesson1_grt_rtw/rtGetNaN.c $(START_DIR)/s_fun_lesson1_grt_rtw/rt_nonfinite.c $(START_DIR)/s_fun_lesson1_grt_rtw/s_fun_lesson1.c $(START_DIR)/s_fun_lesson1_grt_rtw/s_fun_lesson1_data.c rt_matrx.c rt_printf.c rt_logging.c $(START_DIR)/timestwo.c
...
OBJS = rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj s_fun_lesson1.obj s_fun_lesson1_data.obj rt_matrx.obj rt_printf.obj rt_logging.obj timestwo.obj
...
%.obj : $(START_DIR)/s_fun_lesson1_grt_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" "$<"
