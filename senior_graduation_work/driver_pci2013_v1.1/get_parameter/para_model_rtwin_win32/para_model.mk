...
MODEL                := para_model
MODULES              := para_model_data.c rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c 
MAKEFILE             := para_model.mk
MATLAB_ROOT          := D:/PROGRA~1/MATLAB/R2013b
MATLAB_BIN           := D:/PROGRA~1/MATLAB/R2013b/bin
S_FUNCTIONS          := get_para.c
S_FUNCTIONS_LIB      := 
SOLVER               := 
NUMST                := 1
TID01EQ              := 0
...
#
MODELLIB                  := para_modellib_rtwin.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := para_model_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;C:/Users/lenovo/Documents/MATLAB/senior_graduation_work/driver_pci2013_v1.1/get_parameter/para_model_rtwin_win32;C:/Users/lenovo/Documents/MATLAB/senior_graduation_work/driver_pci2013_v1.1/get_parameter;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
