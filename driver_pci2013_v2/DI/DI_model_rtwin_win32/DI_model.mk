...
MODEL                := DI_model
MODULES              := rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c 
MAKEFILE             := DI_model.mk
...
#
MODELLIB                  := DI_modellib_rtwin.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := DI_model_ref.rsp
MODELREF_INC_PATH         := 
