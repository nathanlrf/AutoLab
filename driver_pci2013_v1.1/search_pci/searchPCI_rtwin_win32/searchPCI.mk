...
MODEL                := searchPCI
MODULES              := rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c searchPCI_data.c 
MAKEFILE             := searchPCI.mk
MATLAB_ROOT          := d:/PROGRA~1/MATLAB/R2013b
MATLAB_BIN           := d:/PROGRA~1/MATLAB/R2013b/bin
S_FUNCTIONS          := search.c
S_FUNCTIONS_LIB      := 
SOLVER               := 
NUMST                := 2
TID01EQ              := 1
...
#
MODELLIB                  := searchPCIlib_rtwin.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := searchPCI_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;C:/Users/lenovo/Documents/MATLAB/senior_graduation_work/driver_pci2013_v1.1/search_pci/searchPCI_rtwin_win32;C:/Users/lenovo/Documents/MATLAB/senior_graduation_work/driver_pci2013_v1.1/search_pci;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
